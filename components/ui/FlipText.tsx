	...
	return (
		...
		>
			{words.map((word, wordIndex) => {
				...
				return (
					<span
						// biome-ignore lint/suspicious/noArrayIndexKey: word order is static, derived from a fixed text prop
						key={wordIndex}
					...
					>
						{chars.map((char, charIndex) => {
							...
							return (
								<span
									// biome-ignore lint/suspicious/noArrayIndexKey: character order is static, derived from a fixed text prop
									key={charIndex}
